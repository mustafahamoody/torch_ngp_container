...
if __name__ == "__main__":
    ...
    blend_file = '../belender/stonehenge.blend'     # Blend file of your scene

    ### PLANNER CONFIGS
    # X, Y, Z
    # start_pos = [-0.20, 0.95, 0.28]   # Starting position [x,y,z]
    # end_pos = [2.7, -0.49, 0.28]     # Goal position
    ...
    'res_x': 1920,           # x resolution (BEFORE HALF RES IS APPLIED!)
    'res_y': 1080,           # y resolution
    'trans': False,          # Boolean    (Transparency)
    'mode': 'RGB'          # Can be RGB-Alpha, or just RGB
    }
    ...
    subprocess.run(['blender', blend_file, '-P', 'torch_ngp/viz_data_blend.py', '--', opt.workspace, str(bevel_depth)])
